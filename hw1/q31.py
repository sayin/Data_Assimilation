# -*- coding: utf-8 -*-
"""
Created on Thu Feb  6 11:20:08 2020
...
for i in range(z_loc.shape[0]):
     ...
     z_loc[i,0] = np.random.rand(1)
     z_loc[i,1] = np.random.rand(1)
